...
class JoleRLAlgorithm(RLAlgorithm):
    """This class implements OffPolicyRLAlgorithm for JoLE RL algorithms.
    ...
    def train_model():
        """train dynamic and reward models"""
        raise NotImplementedError

    def do_jole():
        """joint learning of policy, qf and dynamic models""" 
        raise NotImplementedError
