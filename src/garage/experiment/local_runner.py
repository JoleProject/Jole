...
class LocalRunner:
    ...
    def obtain_samples(self, itr, batch_size=None, is_evaluate=False):
        ...
        if not is_evaluate:
            ...
            itr, (batch_size or self.train_args.batch_size), is_evaluate)
        else:
            return self.sampler.obtain_samples_for_evaluation(
                1)
