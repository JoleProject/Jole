...
class ContinuousMLPObsFunction(EnvFunction2):
    """
    Continuous MLP QFunction.
    ...
    def __init__(self,
        ...
        self.model = MLPMergeModel(output_dim=self._obs_dim,
    ...
    def get_obs_val(self, observation, action):
    ...
    @overrides
    def get_fval_sym(self, state_input, action_input, name):
        """
